...
const ChampScoreCategory = ({ title, champScoreData, averageScoreData, specifyActiveCategory, isActive }) => {
  ...
  return (
    <TouchableOpacity onPress={() => specifyActiveCategory(title)}>
      <CategoryBtnBox style={styles.scoreCategoryItem} CurrentActive={CurrentActive}>
        <View>
          <CategoryBtnTitle style={styles.scoreCategoryTitle} CurrentActive={CurrentActive}>
            {title}
          </CategoryBtnTitle>
        ...
        <View>
          <CategoryBtnValue
            ...
            style={title === 'Score' ? styles.champScoreValue : styles.scoreCategoryValue}>
            {champScoreData[title]}
          </CategoryBtnValue>
          {title !== 'Score' && <Text style={styles.scoreAvgValue}>{averageScoreData[title]}</Text>}
        </View>
      </CategoryBtnBox>
    </TouchableOpacity>
  );
...
const CategoryBtnBox = styled.View`
  background-color: ${(props) => (props.CurrentActive ? theme.mainBlue : 'white')};
`;
